            ...
            <table align="center" style="margin-top:50px; width:531px; height:563px; background-color:darkcyan">
                ...
                <tr>
                    <td align="center" style="vertical-align:top">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="First name is mandotary" ControlToValidate="TextBox1" ForeColor="Red">*</asp:RequiredFieldValidator>
                    ...
                    <td align="center" style="vertical-align:top"> 
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Last name is mandotary" ControlToValidate="TextBox2" ForeColor="Red">*</asp:RequiredFieldValidator>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Image ID="Image1" runat="server" BorderColor="Black" BorderWidth="2px" ImageUrl="~/Images/cards.png" Width="438px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
